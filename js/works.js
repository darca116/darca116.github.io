const works_library = {
    ...
    'tatol': {
        ...
        'explain': [
                    ...
                    '『公立はこだて未来大学に生息する仮想生物』をテーマに、Arduinoを活用して制作する授業で作成しました。',
                    '',
                    '未来大に多く設置されている円卓テーブルをモチーフに、大学のある亀田ともかけてカメの守り神という設定を考えました。',
                    'まだ子どもなので擬態は出来ず、好奇心旺盛なので逆に人間に気付いてもらおうとしています。',
                    'そのため人が近づくと自らを光らせて居場所を知らせようとします。',
                    '',
                    'BlenderやIllustratorでイメージを形にして、レーザー加工機などで実際のモノを作りました。',
                    '台座の下にはArudinoとセンサーが隠されていて、検知していないと首を振って周囲を見渡し、検知すると発光するようになっています。',
